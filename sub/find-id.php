...
<div id="container" class="page-find-id">
    <div class="article-header">
        <div class="article-header__inner wrap-narrow">
            <h2 class="article-title"><?php echo $lang['Forgetaccount']; ?></h2>
            ...
            <div class="find-user-info">
                <div class="form-field-wrap">
                    <div class="form-field-item form-email required">
                        <label class="form-label" for="join-email"><span><?php echo $lang['EMail']; ?></span></label>
                        <div class="form-input__wrap">
                            <div class="form-input__inner">
                                <input type="text" class="form-input" id="join-email" required>
                            </div>
                            <p class="valid-message valid-message--info"><i class="icon"></i><span><?php echo $lang['enterE-Mail']; ?></span></p>  
                        </div><!-- .form_input_wrap -->
                    </div><!-- .form-field-item -->
                </div><!-- .form-field-wrap -->
            </div>
            <div class="btn-wrap center btn-confirm"><a href="#" class="btn-basic btn-primary" onclick="check_find_id();"><?php echo $lang['OK']; ?></a></div>
        </div><!-- .wrap-narrow -->
    </div><!-- .article-body -->
</div><!-- #container -->
