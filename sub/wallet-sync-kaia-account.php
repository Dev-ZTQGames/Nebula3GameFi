...
$query = mysqli_query($connect, "SELECT * FROM AccountsChain WHERE m_login_id = '".$_SESSION['sess_login_id']."' AND m_symbol = 'KAIA'");
...
$("#sync_account").on('click',function(){
	...
	$.ajax({
	   type:"POST",        
	   url:"/includes/proc_kaiaWallet.php",     
