...
$query_launchpad = mysqli_query($connect, "SELECT * FROM GamesNFTLaunchpad WHERE m_index = '".$idx."'");
                ...
                <div class="launchpad-view__right">
                    <div class="launchpad-view__info">
                        <div class="launchpad-view__tit">
                            <figure class="launchpad-view__logo"><img src="<?php echo $info_launchpad['m_icon']; ?>" alt=""></figure>
                            <div class="launchpad-view__tit__info">
                                <h3><?php echo $info_launchpad['m_title'];?></h3>
                                <p class="goods"><?php echo $chain_icon; ?><span><?php echo $info_launchpad['m_chain'];?></span></p>
                            </div>
                        </div>
                        <ul class="sns-list">
							<?php
								if ($info_launchpad['m_web_url'] != "") {
							?>
                            <li class="sns-web"><a href="<?php echo $info_launchpad['m_web_url']; ?>" target="_blank"><span class="sr-only">web site</span></a></li>
							<?php
								}
								if ($info_launchpad['m_dc_url'] != "") {
							?>
                            <li class="sns-discord"><a href="<?php echo $info_launchpad['m_dc_url'];?>" target="_blank"><span class="sr-only">discord</span></a></li>
							<?php
								}
								if ($info_launchpad['m_x_url'] != "") {
							?>
                            <li class="sns-twitter"><a href="<?php echo $info_launchpad['m_x_url'];?>" target="_blank"><span class="sr-only">twitter</span></a></li>
							<?php
								}
								if ($info_launchpad['m_tg_url'] != "") {
							?>
                            <li class="sns-telegram"><a href="<?php echo $info_launchpad['m_tg_url'];?>" target="_blank"><span class="sr-only">telegram</span></a></li>
							<?php
								}
							?>
                        </ul>
                    ...
                    <div class="launchpad-view__mint-info">
						<?php
							$launch_info = explode("|", $info_launchpad['m_launch_info']);
							$price = explode("|", $info_launchpad['m_price']);
							$pieces = explode("|", $info_launchpad['m_pieces']);
							$limit = explode("|", $info_launchpad['m_limit']);
							$date_mint = explode("|", $info_launchpad['m_date_mint']);
...
<script>
var game_code = '<?php echo $info_launchpad['m_game_code']; ?>';
