...
$query = mysqli_query($connect, "SELECT * FROM AccountsChain WHERE m_login_id = '".$_SESSION['sess_login_id']."' AND m_symbol = 'ETH'");
        ...
        <div class="wrap">
            <div class="sync-account">
                ...
                <div class="sync-account__dsec">
                    <p>Please enter your BNB Mainnet wallet address.</p>
