...
export declare type BatchId = bigint;
export declare type BatchOperationKind = {
...
export declare type ChunkId = bigint;
export declare type ClearArguments = Record<string, never>;
...
export default interface _SERVICE {
    ...
    create_batch: (arg_0: Record<string, never>) => Promise<{
        batch_id: BatchId;
    }>;
    create_chunk: (arg_0: {
        content: Uint8Array;
    ...
    list: (arg_0: Record<string, never>) => Promise<Array<{
        key: Key;
        encodings: Array<{
            modified: Time;
            sha256: [] | [Uint8Array];
